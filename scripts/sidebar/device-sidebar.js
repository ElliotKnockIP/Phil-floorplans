import { updateSliderTrack, createSliderInputSync, setupColorControls, preventEventPropagation, createToggleHandler, setMultipleObjectProperties, safeCanvasRender } from "./sidebar-utils.js";
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  window.showDeviceProperties = function (deviceType, textObject, group) {
    ...
    if (textObject && deviceLabelInput) {
      ...
      // Initialize text color and background color pickers
