...
export function setupTitleBlockTool(fabricCanvas) {
  ...
  // Handle escape key to stop mode
  ...
  console.log("Title block tool setup complete with save system integration");
}
