/* device-sidebar.js - Nuclear fix for text visibility */
...
// Initialize device sidebar controls on DOM load
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Nuclear text visibility management
  ...
  // Enhanced updateIconSize function for device-sidebar.js

  // Updates the size of a device icon - enhanced to work with scale background settings
  function updateIconSize(size) {
    ...
    if (imageObj && circleObj) {
      ...
      setMultipleObjectProperties(circleObj, {
        ...
        scaleX: 1, // Reset scale since we're adjusting radius directly
        scaleY: 1,
      });
  ...
  // Enhanced showDeviceProperties function to properly display current icon size
  ...
  // NUCLEAR DEVICE LABEL TOGGLE - completely removes/adds text to canvas
