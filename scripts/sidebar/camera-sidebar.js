...
// Initialize camera sidebar controls on DOM load
document.addEventListener("DOMContentLoaded", () => {
  ...
  wrapGlobalFunction("showDeviceProperties", (deviceType, textObject, group) => {
    ...
    // FIX: Update distance slider to show correct distance based on current radius
    ...
    // FIX: Update angle slider to show correct angle span
