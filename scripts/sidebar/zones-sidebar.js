...
// Initialize zone sidebar controls on DOM load
document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateZoneColor(color) {
    ...
    setMultipleObjectProperties(currentTextObject, { cursorColor: strokeColor });
  }
