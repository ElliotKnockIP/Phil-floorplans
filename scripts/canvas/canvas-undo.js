// canvas-undo.js - Fixed Undo System
...
class CanvasUndoSystem {
  constructor(fabricCanvas) {
    ...
    this.isDrawingMode = false; // Track if we're in drawing mode
  ...
  setupObjectAddedTracking() {
    ...
    this.fabricCanvas.on("object:added", (e) => {
      ...
      if (this.isDrawingModeObject(obj)) {
        // Don't create undo commands for individual drawing objects
        // They will be handled by the drawing tools themselves
        return;
      }
