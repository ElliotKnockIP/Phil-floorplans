...
export function initConnection(fabricCanvas) {
  const addLineButton = document.getElementById("add-connection-btn");
  ...
  addLineButton.addEventListener("click", activateConnectionDrawing);

  function activateConnectionDrawing() {
    closeSubSidebar(subSidebar);
    registerDrawingMode(fabricCanvas, "connection", stopDrawing);
